...
import java.util.ArrayList;
 ...
 public class NorthFirstMazeSolver extends MazeSolver implements Runnable {
        ...
        public NorthFirstMazeSolver ( Maze m, Graphics g ) {
            super(m);
            myG = g;
            returningHome = false;
            workerActive = false;
    ...
    public void solveMaze() {
       ...
       col = 0;
		...
		//        NORTH means "row-1")
                if(unvisitedList.get(0) == "N")
                    row -= 1;
                else if(unvisitedList.get(0) == "W")
                    col -= 1;
                else if(unvisitedList.get(0) == "S")
                    row += 1;
                else if(unvisitedList.get(0) == "E")
                    col += 1;
